...
instance Print (AbsGramar.TopDef' a) where
  prt i = \case
    AbsGramar.FnDef _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    AbsGramar.GlobDecl _ type_ item -> prPrec i 0 (concatD [prt 0 type_, prt 0 item, doc (showString ";")])
...
instance Print (AbsGramar.Stmt' a) where
  prt i = \case
    ...
    AbsGramar.For _ id_ expr1 expr2 block -> prPrec i 0 (concatD [doc (showString "for"), prt 0 id_, doc (showString "="), doc (showString "("), prt 0 expr1, doc (showString ")"), doc (showString "to"), doc (showString "("), prt 0 expr2, doc (showString ")"), prt 0 block])
...
instance Print (AbsGramar.Type' a) where
  prt i = \case
    AbsGramar.Int _ -> prPrec i 0 (concatD [doc (showString "int")])
    AbsGramar.Str _ -> prPrec i 0 (concatD [doc (showString "string")])
    AbsGramar.Bool _ -> prPrec i 0 (concatD [doc (showString "boolean")])
    AbsGramar.Fun _ type_ types -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 types, doc (showString ")")])
...
instance Print (AbsGramar.Expr' a) where
  prt i = \case
    ...
    AbsGramar.EApp _ id_ exprs -> prPrec i 6 (concatD [prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
