...
transTopDef x = case x of
  ...
  AbsGramar.GlobDecl _ type_ item -> failure x
...
transType x = case x of
  AbsGramar.Int _ -> failure x
  AbsGramar.Str _ -> failure x
  AbsGramar.Bool _ -> failure x
  AbsGramar.Fun _ type_ types -> failure x
